package fcs.sheng.req.user;

import fcs.sheng.req.QueryReq;
...
public class UserQueryReq  extends QueryReq {
    ...
    /** 用户类型 {@link fcs.sheng.enumeration.user.UserTypeEnum} */
    private Integer userType;

    /** 账号状态 {@link fcs.sheng.enumeration.user.UserStateEnum } */
    ...
    /** 根据注册时间排序 {@link fcs.sheng.enumeration.OrderEnum} */
